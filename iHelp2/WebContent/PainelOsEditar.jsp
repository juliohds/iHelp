	...
	<div class="container-fluid display-table">
		...
		<div class="row display-table-row">
			...
			<div class="col-md-10 col-sm-11 display-table-cell v-align">
				...
				<div class="row">
					<header>
						<h3 style="text-align: center;">${voluntario.nome} | Editar Organização Social</h3>
						<hr>
						<div class="col-md-5">
						...
						<div class="col-md-6">
					    	...
					    	<a href="ManterOs.do?acao=Carregar" class="btn btn-success">Voltar</a>
					    	<button type="reset" class="btn btn-info">Restaurar</button>
						</div>
